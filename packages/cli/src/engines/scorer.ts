// ============================================================
// @nxlv-ai/lovable-audit — Risk Scorer (expanded with rationale + LOV levels)
// ============================================================
...
// Score is reported on a 0–100 scale (riskScore is documented as "0–100" and
// the UI renders "X/100"). Catastrophic is therefore reachable only at the cap.
...
export function calculateRiskScore(
  ...
  // auditable); the returned score is clamped to the 0–100 reporting scale.
  return { score: Math.min(score, MAX_SCORE), rationale };
}
