...
export function toHTML(
  ...
  return [
    ...
    '<title>NXLV Shield — Security Audit Report</title>',
    '<style>',
    ...
    '</style>',
    '</head><body>',
    '<h1>🛡️ NXLV Shield — Security Audit Report</h1>',
    ...
    '<h2>Projects</h2>',
    sections,
    `<p class="sub">Generated by <a href="https://github.com/nxlv/lovable-portfolio-audit">NXLV Shield</a> — The Lovable Production-Readiness Standard</p>`,
    script,
    '</body></html>',
  ].join('\n');
}
