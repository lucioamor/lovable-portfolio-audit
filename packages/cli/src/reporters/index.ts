// ============================================================
// @nxlv-ai/lovable-audit — Reporters (Console + JSON + SARIF + Markdown)
// ============================================================
...
export function formatScanSummary(
  ...
  const lines: string[] = [
    '',
    chalk.bold('═══════════════════════════════════════════════'),
    chalk.bold('  🛡️  NXLV Lovable Portfolio Audit — Scan Complete'),
    chalk.bold('═══════════════════════════════════════════════'),
    '',
...
export function toSARIF(results: ProjectScanResult[]): string {
  ...
  const sarif = {
    ...
    runs: [{
      tool: {
        driver: {
          name: 'NXLV Lovable Portfolio Audit',
          version: '0.1.0',
...
export function toMarkdown(
  ...
  const lines: string[] = [
    '# 🛡️ NXLV Lovable Portfolio Audit — Security Audit Report',
    '',
    `**Scan Date:** ${scanDate}`,
    `**Projects Scanned:** ${summary.scannedProjects}/${summary.totalProjects}`,
    '',
  ...
  lines.push('*Generated by [NXLV Lovable Portfolio Audit](https://github.com/lucioamor/lovable-portfolio-audit) — The Lovable Production-Readiness Standard*');
...
export function toHTML(
  ...
  return [
    ...
    '<title>NXLV Lovable Portfolio Audit — Security Audit Report</title>',
    '<style>',
    ...
    '</style>',
    '</head><body>',
    '<h1>🛡️ NXLV Lovable Portfolio Audit — Security Audit Report</h1>',
    ...
    '<h2>Projects</h2>',
    sections,
    `<p class="sub">Generated by <a href="https://github.com/lucioamor/lovable-portfolio-audit">NXLV Lovable Portfolio Audit</a> — The Lovable Production-Readiness Standard</p>`,
    script,
    '</body></html>',
  ].join('\n');
}
